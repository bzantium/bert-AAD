...
if __name__ == '__main__':
    ...
    src_list = ["books", "dvd", "electronics", "kitchen"]
    tgt_list = ["books", "dvd", "electronics", "kitchen", "blog"]
    ...
    for src in src_list:
        for tgt in tgt_list:
            ...
            src_reviews, src_labels = XML2Array(os.path.join('data', src, 'negative.review'),
                                                os.path.join('data', src, 'positive.review'))

            if tgt == 'blog':
                tgt_X, tgt_Y = TSV2Array(os.path.join('data', tgt, 'blog.review'))

            else:
                tgt_X, tgt_Y = XML2Array(os.path.join('data', tgt, 'negative.review'),
                                         os.path.join('data', tgt, 'positive.review'))
